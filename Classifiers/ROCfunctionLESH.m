function [GAR, FAR, ProbG, ProbI, score] = ROCfunctionLESH(file_name, step)
...
if fusion == 0
    ...
    file_name = '\\ece-bmll-file.ad.ufl.edu\research\UF_Users\Arpita\LandMine\NewData\Feature Extractors\LESH\MH\';
